...
public class SpecialCharacters {
        public static void main(String[] args) {
            String inputFilePath = "C:\\Users\\raagaviv\\Desktop\\input.txt";   // Path to input text file
            String outputFilePath = "C:\\Users\\raagaviv\\Desktop\\output.txt"; // Path to output text file
